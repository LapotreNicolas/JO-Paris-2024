<x-layout titre="Modification sport">
    @if ($errors->any())
        <div>
            <ul>
    ...
    <form action="{{route('sports.update',$sport->id)}}" method="POST">
        ...
        <div>
            ...
            <input type="number" min="1" max="10" value="{{ $sport['nb_disciplines'] }}" name="nb_disciplines">
        </div>
        <div>
            <label for="nb_epreuves"><strong>Nombre d'épreuves :</strong></label>
            <input type="number" min="1" max="10" value="{{ $sport['nb_epreuves'] }}" name="nb_epreuves">
        </div>
        <div>
