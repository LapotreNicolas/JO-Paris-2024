    ...
    <x-layout>
        ...
        <form action="{{route('sports.store')}}" method="POST">
            ...
            <div>
                ...
                <input type="number" placeholder="1900" name="annee_ajout">
            </div>
            <div>
                <label for="nb_disciplines"><strong>Nombre de disciplines :</strong></label>
                <input type="range" min="1" max="10" value="1" name="nb_disciplines">
            </div>
            <div>
                <label for="nb_epreuves"><strong>Nombre d'épreuves :</strong></label>
                <input type="range" min="1" max="10" value="1" name="nb_epreuves">
            </div>
            <div>
